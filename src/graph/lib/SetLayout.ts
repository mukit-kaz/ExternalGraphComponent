...
export async function SetLayout(
  ...
  switch (selectedLayout) {
    case Graph_Layout.Hierarchic:
      return await LayoutHierarchic(graph, selectedOrientation, controll);

    case Graph_Layout.Tree:
      return await LayoutTree(graph, selectedOrientation, controll);

    case Graph_Layout.Circular:
      return await LayoutCircular(graph, selectedOrientation, controll);
