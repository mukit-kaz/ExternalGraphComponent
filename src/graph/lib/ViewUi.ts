...
import { ShapeColor, ShapeStyle, TableBodyColor } from "../type/type";

export function TableViewUi(table?: TableBodyColor) {
    return `
    <div style={{ position: 'absolute', top: '0', left: '0', bottom: '0', right: '0', overflow: 'hidden', fontFamily: 'Arial, Helvetica, sans-serif', borderWidth: '2px', borderStyle: 'solid', borderColor: '${table.tableBorderColor}', borderTopWidth: '5px', borderTopStyle: 'solid', borderTopColor: tag?.value?.tableBorderColor, borderRadius: '4px' }}>
    <div style={{ position: 'absolute', top: '0', left: '0', bottom: '0', right: '0', height: '32px' }}>
        <h5 style={{ whiteSpace: 'nowrap', textOverflow: 'ellipsis', overflow: 'hidden', color: '${table.titleColor}', padding: '3px', marginBottom: '0', backgroundColor: '${table.titleBgColor}', borderBottom: '1px solid #dee2e6', fontSize: '16px', marginTop: '0' }}>{tag.name}</h5>
    </div>
    <div style={{ position: 'absolute', top: '27px', left: '0', bottom: '0', right: '0', padding: '3px', backgroundColor: '${table.tableBgColor}' }}>
        <table style={{ borderCollapse: 'collapse', width: '100%', tableLayout: 'fixed', fontSize: '13px' }}>
            <tbody>
                <tr>
                    <td style={{ color: '${table.tableColTextColor}', whiteSpace: 'nowrap', textOverflow: 'ellipsis', overflow: 'hidden', padding: '3px', textAlign: 'left' }}>Entity Code</td>
                    <td style={{ color: '${table.tableTextColor}', whiteSpace: 'nowrap', textOverflow: 'ellipsis', overflow: 'hidden', padding: '3px', textAlign: 'left' }}>{tag.entityCode}</td>
                </tr>
                <tr>
                    <td style={{ color: '${table.tableColTextColor}', whiteSpace: 'nowrap', textOverflow: 'ellipsis', overflow: 'hidden', padding: '3px', textAlign: 'left' }}>Business Type</td>
                    <td style={{ color: '${table.tableTextColor}', whiteSpace: 'nowrap', textOverflow: 'ellipsis', overflow: 'hidden', padding: '3px', textAlign: 'left' }}>{tag.businessType}</td>
                </tr>
                <tr>
                    <td style={{ color: '${table.tableColTextColor}', whiteSpace: 'nowrap', textOverflow: 'ellipsis', overflow: 'hidden', padding: '3px', textAlign: 'left' }}>Inc. Jurisdiction</td>
                    <td style={{ color: '${table.tableTextColor}', whiteSpace: 'nowrap', textOverflow: 'ellipsis', overflow: 'hidden', padding: '3px', textAlign: 'left' }}>{tag.incorporationJurisdiction}</td>
                </tr>
            </tbody>
        </table>
    </div>
